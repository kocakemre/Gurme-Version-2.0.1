...
final class RegisterViewController: UIViewController {
    ...
    private lazy var facebookLoginButton: UIButton = {
        ...
        button.tintColor = .white
        button.setImage(UIImage(named: Constants.Image.facebookIcon)?.withRenderingMode(.alwaysOriginal), for: .normal)
        button.layer.cornerRadius = Constants.Layout.radius18
    ...
    private lazy var loginButton: UIButton = {
        ...
        button.titleLabel?.font = UIFont(name: Constants.Text.fontArialBold, size: Constants.Layout.font17)
...
private extension RegisterViewController {
    ...
    func showLoginAlert() {
        ...
        alertController.addAction(
            UIAlertAction(
                title: Constants.Text.alertOkButton,
                style: .default,
                handler: nil
            )
        )
...
private extension RegisterViewController {
    ...
    @objc func registerButtonClicked() {
        ...
        guard let email = emailTextField.text, !email.isEmpty,
            ...
            showStandardAlert(
                Constants.Text.alertWarningTitle,
                Constants.Text.emptyFieldsWarning,
                .alert,
                Constants.Text.alertOkButton,
                .default
            )
            return
        }
