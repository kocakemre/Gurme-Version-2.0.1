...
extension VC_OnBoarding {
    ...
    func setupSlideContent() {
        slides = [
            .init(titleHead: "Hey Gurme, Uygulamana Hoşgeldin!", titleChild: "Uygun fiyatlı Gurme yemekleri keşfedip en hızlı şekilde alabileceğin Gurme uygulamasını hemen kullanmaya başla!", animationName: "order", btnColor: UIColor(named: "OrderSkipBtn")!, btnTitle: "İleri"),
            .init(titleHead: "Hemen Keşfet!", titleChild: "Binlerce çeşit gurme yemekleri anında keşfet!", animationName: "orderFood", btnColor: UIColor(named: "OrderFoodSkipBtn")!, btnTitle: "İleri"),
            .init(titleHead: "Çok Kısa Sürede Kapında!", titleChild: "Güler yüzlü Gurme kuryelerle yemeğiniz kısa sürede kapınızda.", animationName: "deliveryGuyOrder", btnColor: UIColor(named: "courierSkipBtn")!, btnTitle: "İleri"),
            .init(titleHead: "Hem leziz Hem İndirimli!", titleChild: "Sana özel kampanyaları hemen keşfet!", animationName: "discount", btnColor: UIColor(named: "OnBoardingGoBtn")!, btnTitle: "Başla!")
        ]
    }
